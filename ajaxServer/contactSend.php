...
<div id="outline">
  ...
  <article> <!-- InstanceBeginEditable name="data" -->
    ...
    <section id="message">
      ...
      <h2>Uw gegevens:</h2>
      <p><strong><span class="error">Naam</span></strong>: <?php echo $_POST['naam'] ?></p>
      <p><strong><span class="error">E-mail</span></strong>: <a href="mailto:<?php echo $_POST['email'] ?>"><?php echo $_POST['email'] ?></a></p>
      <p><strong><span class="error">Onderwerp</span></strong>: <?php echo $_POST['onderwerp'] ?></p>
      <p><strong><span class="error">Bericht</span></strong>: <br>
        <?php echo $_POST['bericht'] ?></p>
    </section>
    <!-- end .content --> 
